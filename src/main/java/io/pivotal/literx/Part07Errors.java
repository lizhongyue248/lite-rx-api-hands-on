...
//========================================================================================
  ...
  /**
   * Return a Mono<User> containing User.SAUL when an error occurs in the input Mono, else do not
   * change the input Mono.
   *
   * @param mono mono
   * @return mono
   */
...
//========================================================================================
  ...
  /**
   * Implement a method that capitalizes each user of the incoming flux using the #capitalizeUser
   * method and emits an error containing a GetOutOfHereException error.
   *
   * @param flux flux
   * @return flux
   */
